...
/**
 * Servlet implementation class TeacherLookStudentListServlet
 */
public class TeacherLookStudentListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TeacherLookStudentListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		response.sendRedirect(request.getContextPath() + "/teacher/TEA_Show_stu.jsp");
		//request.getRequestDispatcher("/teacher/TEA_Show_stu.jsp").forward(request, response);
	}
