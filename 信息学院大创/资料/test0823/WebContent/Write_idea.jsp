...
<title>填报志愿</title>
<link href="${pageContext.request.contextPath }/css/Change_idea.css"
	rel="stylesheet" />
<script type="text/javascript"
	src="${pageContext.request.contextPath }/js/changeorder.js">
						...
						<div id="con">
							...
							<div id="dataSource">
								...
								<div id="dataSourceOne" data-value="A" data-name="major" ondrop="drop(event,this)"
									...
									ondragstart="drag(event, this)"><input id="text_name" style="width:120px" name="major" value="计算机科学与技术" readonly></div>
								<div id="dataSourceTwo" data-value="B" data-name="major" ondrop="drop(event,this)"
									ondragover="allowDrop(event)" draggable="true"
									ondragstart="drag(event, this)"><input id="text_name" style="width:100px" name="major" value="数字媒体技术" readonly="true"></div>
								<div id="dataSourceThree" data-value="C" data-name="major"
									ondrop="drop(event,this)" ondragover="allowDrop(event)"
									draggable="true" ondragstart="drag(event, this)"><input style="width:80px" id="text_name" name="major" value="网络工程" readonly="true"></div>
								<div id="dataSourceFour" data-value="D" data-name="major"
									ondrop="drop(event,this)" ondragover="allowDrop(event)"
									draggable="true" ondragstart="drag(event, this)"><input style="width:90px" id="text_name" name="major" value="物联网方向" readonly="true"></div>
							</div>
						</div>
						<br>
						${begintime}开始填报<br>
